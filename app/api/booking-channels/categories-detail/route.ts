...
const allCategories: Category[] = [
  { id: 'direct', name: 'Direct', color: CATEGORY_COLORS.direct },
  { id: 'ota', name: 'OTA', color: CATEGORY_COLORS.ota },
  { id: 'corporate', name: 'Corporate', color: CATEGORY_COLORS.corporate },
  { id: 'groups', name: 'Groups', color: CATEGORY_COLORS.groups },
  { id: 'other', name: 'Other', color: CATEGORY_COLORS.other },
  { id: 'wholesale', name: 'Wholesale', color: CATEGORY_COLORS.wholesale },
  { id: 'loyalty', name: 'Loyalty Program', color: CATEGORY_COLORS.loyalty },
    ...
    response.pieData[dataset.id] = response.categories.map(category => {
      ...
      if (dataset.id === 'revenue') {
        ...
        if (category.id === 'direct') {
          ...
          baseValue = 30 + Math.floor(Math.random() * 30) // 30-60 days
        } else if (category.id === 'groups') {
        ...
        if (category.id === 'direct') {
          baseValue = 20 + Math.floor(Math.random() * 40) // Lower cancellations for direct
        } else if (category.id === 'ota') {
          baseValue = 80 + Math.floor(Math.random() * 150) // Higher for OTAs
        } else if (category.id === 'corporate') {
          baseValue = 30 + Math.floor(Math.random() * 60) // Medium for corporate
        } else if (category.id === 'groups') {
          baseValue = 5 + Math.floor(Math.random() * 15) // Very low for groups
        } else {
          baseValue = 30 + Math.floor(Math.random() * 70) // Medium-high for others
        }
        ...
        if (category.id === 'direct') {
          ...
          baseValue = 200 + Math.floor(Math.random() * 100) // 2.0-3.0 nights
        } else if (category.id === 'groups') {
      ...
      response.categories.forEach(category => {
        ...
        if (dataset.id === 'revenue') {
          ...
          if (category.id === 'direct') {
            ...
            basePct = 60 + Math.floor(Math.random() * 20) // 60-80%
          } else if (category.id === 'groups') {
          ...
          if (category.id === 'direct') {
            baseValue = 10 + Math.floor(Math.random() * 20) // Lower cancellations for direct
          } else if (category.id === 'ota') {
            baseValue = 40 + Math.floor(Math.random() * 80) // Higher for OTAs
          } else if (category.id === 'corporate') {
            baseValue = 15 + Math.floor(Math.random() * 30) // Medium for corporate
          } else if (category.id === 'groups') {
            baseValue = 3 + Math.floor(Math.random() * 7) // Very low for groups
          } else {
            baseValue = 15 + Math.floor(Math.random() * 35) // Medium-high for others
          }
        } else if (dataset.id === 'alos') {
          ...
          if (category.id === 'direct') {
            ...
            baseValue = 2.0 + Math.random() * 1.0 // 2.0-3.0 nights
          } else if (category.id === 'groups') {
    ...
    datasets.forEach(dataset => {
      ...
      if (response.pieData[dataset.id]) {
        ...
        if (category.id === 'direct') {
          ...
          current = 60 + Math.floor(Math.random() * 20) // 60-80%
        } else if (category.id === 'groups') {
        ...
        if (category.id === 'direct') {
          ...
          current = 30 + Math.floor(Math.random() * 30) // 30-60 days
        } else if (category.id === 'groups') {
        ...
        if (category.id === 'direct') {
          ...
          current = 30 + Math.floor(Math.random() * 60)
        } else if (category.id === 'groups') {
        ...
        if (category.id === 'direct') {
          ...
          current = Math.round((2.0 + Math.random() * 1.0) * 10) / 10
        } else if (category.id === 'groups') {
