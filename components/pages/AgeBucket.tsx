...
const roomTypeBuckets = [
  { id: "Standard", value: 280000 },
  { id: "Deluxe", value: 350000 },
  { id: "Suite", value: 180000 },
  { id: "Executive", value: 90000 },
  { id: "Family", value: 60000 },
];
...
type Tab = 'All' | '18-24' | '25-34' | '35-44' | '45-54' | '55+';
...
const ageBucketTableData: AgeBucketTableData[] = [
  {
    ageBucket: "18-24",
    rooms: 150,
    totalRevenue: 35000,
...
const AgeBucketTable = ({ data, comparisonType }: { data: AgeBucketTableData[], comparisonType: string }) => {
    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-md overflow-hidden">
      <div className="overflow-x-auto">
        <div className="flex justify-between items-center bg-white px-6 py-4">
          <h2 className="text-lg font-semibold bg-white text-gray-800">All age buckets</h2>
        </div>
        <table className="min-w-full divide-y divide-gray-300 border-t border-gray-300">
          <thead className="bg-gray-50 uppercase ">
            <tr >
              <th className="px-6 py-4 text-left text-sm font-medium text-gray-800">Age Bucket</th>
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map((row, index) => (
              <tr key={index}>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray- border-r border-gray-300 text-sm">{row.ageBucket}</td>
...
export function AgeBucketDashboard() {
      ...
      <div className="p-8">
        ...
        <div className="flex flex-col mb-6">
          <div className="flex justify-between items-center">  
            <div className="flex items-center">
              <h2 className="text-3xl font-bold text-gray-800">Age Buckets</h2>
            </div>
          ...
          <div className="flex space-x-8 mt-6 border-b">
            {(['All', '18-24', '25-34', '35-44', '45-54', '55+'] as Tab[]).map((tab) => (
              <button
                key={tab}
        ...
        <div className="grid grid-cols-1 gap-8">
          {selectedTab === 'All' ? (
            <AgeBucketTable data={ageBucketTableData} comparisonType={comparisonType} />
          ) : (
            renderChart(roomTypeBuckets, "Room types", "roomTypeBuckets")
          )}
        </div>
