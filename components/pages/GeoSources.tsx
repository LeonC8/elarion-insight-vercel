...
type Country = 'All' | string; // string will be country names
    ...
    <div className="bg-white border border-gray-200 shadow-md rounded-lg overflow-hidden">
      <div className="overflow-x-auto">
        <div className="flex justify-between items-center bg-white px-6 py-4">
          <h2 className="text-lg font-semibold bg-white text-gray-800">All countries</h2>
        </div>
        <table className="min-w-full divide-y border-t border-gray-300 divide-gray-300">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {data.map((row, index) => (
              <tr key={index}>
                <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-800 bg-gray-0 border-r border-gray-300 text-sm">{row.channel}</td>
...
export function GeoSourcesDashboard() {
  ...
  // Move the countries array inside the component
  const countries = [
    'All',
    'United States',
    'United Kingdom',
  ...
  // Move the countryData inside the component
  const countryData: BookingChannelTableData[] = [
    {
      ...
      <div className="p-8">
        ...
        <div className="flex flex-col mb-6">
          ...
          <div className="flex items-center mt-6">
            <span className="text-sm font-medium text-gray-900 mr-4 ">Country:</span>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
        ...
        <div className="grid grid-cols-1 gap-8">
          {selectedCountry === 'All' ? (
            <BookingChannelsTable data={countryData} comparisonType={comparisonType} />
          ) : (
